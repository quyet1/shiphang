            ...
            <div class="bg-blue">
               ...
               <div class="row">
                  <div class="search-widget-area col-sm-12" id="search-box">
                     <form class="form-inline form-adjacent" name="search" action="timkiemnhanh" method="GET">
                                       ...
                                       <select data-placeholder="Tất cả dịch vụ" data-search-input-placeholder="Tìm dịch vụ" class="select-category" id="cateListMainSearch" name="id">
                                          ...
                                          <?php
                                             if(isset($this->catalogzz)){//$this->catalog
                                                 foreach($this->catalogzz as $key=>$test){
                                                 //for($i=0; $i<3;$i++){
                                                    echo "<option value='".$test['MADANHMUCTIN']."'>".$test['TENDANHMUCTIN']."</option>";
                                                }
                                             }
                                                       ?>
                                       </select>
...
<!--                                                <option value="">
                           ...
                           <div class="col-sm-2"> 
                               <button type="submit" name="find" class="btn-search btn btn-lg btn-primary"> Tìm việc </button> 
                           </div>
                        </div>
                     </form>
                  </div>
               ...
               <div class="col-2 col-sm-8 col-md-7">
                  <div class="job-search-body">
                     <div class="top-nav">
                        <div class="row">
                            <div>
                                <?php if(isset($this->keys)) echo $this->keys; ?>
                             </div>
                                        ...
                                        echo '<div class="row">';
                                          ...
                                          echo    '<div class="logo">'.'<img title="'
                                                  ...
                                                  if($this->allwork[$i]['img']!=NULL){
                                                      echo __SITE_PATH.$this->allwork[$i]['img'];
                                                  }
                                                  else{
                                                      echo __SITE_PATH.'public/images/logo/shipper-logo.png';
                                                 }
                                                  echo '">'
                                                  . ' </div>';
                                           echo '</div>';
